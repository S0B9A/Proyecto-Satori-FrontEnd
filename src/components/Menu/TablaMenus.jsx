    ...
    return (
        <TableHead>
            <TableRow>
                <TableCell>
                    <Tooltip title="Crear">
                        <IconButton component={Link} to="/menu/Crear/">
                            <AddIcon />
                        </IconButton>
                    </Tooltip>
                </TableCell>
...
// Barra de opciones
function TablaMenusToolbar(props) {
    const { numSelected, idSelected } = props;
    const navigate = useNavigate();

    const update = () => {
        if (idSelected) {
            navigate(`/menu/update/${idSelected}`);
        }
    };
