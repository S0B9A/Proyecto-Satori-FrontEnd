...
export function CartCombo() {
  const { cartCombo, removeItem, cleanCartCombo, getTotalcombo, getTaxcombo, getTotalSinImpuestoscombo } = useCartCombo();

  return (
    <div style={{ padding: "20px" }}>
      <Tooltip title="Eliminar todos los combos">
        <IconButton
          color="error"
          onClick={cleanCartCombo}
          aria-label="Eliminar"
          sx={{ mb: 2 }}
        >
      ...
      <TableContainer component={Paper} elevation={3}>
        <Table sx={{ minWidth: 650 }} aria-label="tabla de carrito de combos">
          <TableHead>
            <TableRow>
          ...
          <TableFooter>
            <TableRow>
              ...
              <StyledTableCell colSpan={2}>
                <Typography variant="subtitle1">{`¢${getTotalSinImpuestoscombo(cartCombo)}`}</Typography>
              </StyledTableCell>
            </TableRow>
            <TableRow>
              <StyledTableCell colSpan={4} align="right">
              ...
              <StyledTableCell colSpan={2}>
                <Typography variant="subtitle1">{`¢${getTaxcombo(cartCombo)}`}</Typography>
              </StyledTableCell>
            </TableRow>
            <TableRow>
              <StyledTableCell colSpan={4} align="right">
