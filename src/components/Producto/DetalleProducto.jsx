          ...
          <Grid item xs={12} md={6}>
            <CardContent>
              ...
              <Typography variant="body2" sx={{ marginTop: '1rem' }}>
                Tipo: {data.tipo || 'N/A'} | Categoría: {data.categoria || 'N/A'}
              </Typography>
              ...
              <ul>
                {data.estaciones && data.estaciones.length > 0 ? (
                  data.estaciones.map((estacion, index) => (
                    <li key={index}>
                      <Typography variant="body2">{estacion.nombre || 'N/A'}</Typography>
                    </li>
                  ))
                ) : (
                  <li>
                    <Typography variant="body2">No hay estaciones disponibles</Typography>
                  </li>
                )}
              </ul>
              <Box sx={{ marginTop: '1rem', padding: '1rem', border: '1px solid #E0E0E0', borderRadius: '5px', backgroundColor: '#FCE4EC' }}>
                <Typography variant="body2" sx={{ fontWeight: 'bold', color: '#D32F2F' }}>
                  Detalles Asiáticos:
                </Typography>
                <Typography variant="body2">
                  - Este plato es un símbolo de la rica tradición culinaria de Asiatico.
                </Typography>
                <Typography variant="body2">
                ...
                <Box sx={{ marginTop: '1rem' }}>
                  <img 
                    ...
                    alt="Flor de Cerezo"
                    style={{ width: '30px', height: 'auto', display: 'inline-block', marginRight: '10px' }}
                  />
                  <img 
