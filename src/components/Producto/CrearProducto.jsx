  ...
  return (
    <form onSubmit={handleSubmit(onSubmit, onError)} noValidate>
      <Grid container spacing={2} sx={{ padding: 2 }}>
        ...
        <Grid item xs={12} sm={6}>
          <FormControl variant="outlined" fullWidth error={Boolean(errors.categoria)}>
            {loadedCategorias && (
              <Controller
                name="categoria"
                control={control}
        ...
        <Grid item xs={12} sm={6}>
          <FormControl variant="outlined" fullWidth error={Boolean(errors.tipo)}>
            {loadedTipos && (
              <Controller
                name="tipo"
                control={control}
        ...
        <Grid item xs={12}>
          <FormControl variant="outlined" fullWidth error={Boolean(errors.estaciones)}>
            {loadedEstaciones && (
              <Controller
                name="estaciones"
                control={control}
